import { PasetoInvalid, PasetoNotSupported } from '../errors.js'
import { decode } from '../help/base64url.js'
import parsePayload from '../help/parse_paseto_payload.js'

export default (token, /* second arg is private API */ { parse = true } = {}) => {
